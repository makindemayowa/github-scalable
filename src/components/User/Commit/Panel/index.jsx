...
const loader2 = () => (
  <div key={v1()} className="userCommitsPanel__item">
    <h5><span className="loading__background loader2__message commit__message" /></h5>
    <h5 className="loading__background loader2__url commit__url" />
    <h5><span className="loading__background loader2__author" /></h5>
    <h5><span className="loading__background loader2__date" /></h5>
  </div>
)
